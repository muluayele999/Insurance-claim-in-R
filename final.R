...
my.data=read.csv("train_set0506.csv",header=TRUE)
my.data2 = my.data
# Remove Columns 1:8
my.data[ ,(1:8) ]=NULL 
my.data2[,(1:2)] = NULL
...
# Apply PCA
npca.data=my.data[,c(1:9,18,23)]
pca.data=my.data[,-c(1:9,18,23)]
...
scores<-rotated$scores #final rotated PCA
dim(scores)
...
write.csv(my.data.pca,"datapca.csv")
...
z<-ctree(train$C_Claim~.-(train$C_Claim),data=train)
z
plot(z)
